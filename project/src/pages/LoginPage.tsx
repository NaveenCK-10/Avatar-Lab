...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Login - Avatar Lab';
          ...
          <div className="px-6 py-8">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                Sign in to your Avatar Lab account
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <a href="#" className="text-sm text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300">
                    Forgot password?
                  </a>
                </div>
                <input
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link to="/signup" className="text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 font-medium">
                  Sign up
                </Link>
              </p>
            </div>
